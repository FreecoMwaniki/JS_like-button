...
let balance = [
  {
    ...
    title: "YIN&YANG",
    imageUrl:
      "https://cdn.pixabay.com/photo/2013/07/12/18/02/yin-and-yang-152829_640.png",
  ...
  },
  {
    ...
    title: "SCALES",
    imageUrl:
      "https://cdn.pixabay.com/photo/2024/05/12/10/05/libra-8756539_640.png",
...
function increaseLike(id) {
  ...
  if (item) {
    ...
    likeCountElement.textContent = `${item.likes} Likes`;
